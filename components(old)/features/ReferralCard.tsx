...
import { Card, CardHeader, CardBody, CardFooter, Button, Badge, StatsCard } from 'components(old)/ui/tailwick-primitives'
...
import { XPEventOverlay, type XpEventPayload } from 'components(old)/XPEventOverlay'
