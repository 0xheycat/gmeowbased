    ...
    <div className="min-h-screen bg-gradient-to-b from-black via-purple-950/20 to-black">
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-950 dark:text-white/70">
        ...
        <div className="bg-slate-100/5 dark:bg-slate-100/90 dark:bg-white/5 backdrop-blur-sm rounded-2xl border border-white dark:border-slate-700/10 p-8 mb-8">
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-slate-950 dark:text-white/60 mb-6">
        ...
        <div className="bg-gradient-to-br from-purple-600/20 to-pink-600/20 backdrop-blur-sm rounded-2xl border border-purple-500/30 p-8 mb-8">
          ...
          <ul className="space-y-3 text-slate-950 dark:text-white/80">
