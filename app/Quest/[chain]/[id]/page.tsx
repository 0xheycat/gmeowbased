                  ...
                  {loadingQuest ? (
                    ...
                    <>
                      ...
                      <div className="mt-2 text-sm">
                        <strong>Meta</strong>:
                        <pre className="quest-builder-debug rounded mt-2 p-2 text-[11px] text-sky-200 whitespace-pre-wrap">
                ...
                <div id="verify-result" className="mt-3">
                  ...
                  <div className="mt-2">
                    ...
                    <div className="mt-2">
                      ...
                      <pre className="quest-builder-debug rounded mt-2 p-3 text-[11px] whitespace-pre-wrap">
                  ...
                  <div className="mt-3">
                    ...
                    <div className="quest-builder-debug max-h-[260px] overflow-auto text-[11px] p-2 rounded">
                  ...
                  {autoCloseLogs.length ? (
                    <div className="mt-3">
                      ...
                      <div className="quest-builder-debug max-h-[160px] overflow-auto text-[11px] p-2 rounded space-y-1">
              ...
              {!isHydrated ? (
                ...
                <>
                  ...
                  {rankSnapshot.delta > 0 ? (
                    <div className="text-[11px] text-emerald-300 mt-1">+{rankSnapshot.delta.toLocaleString()} points since last update.</div>
                  ) : null}
                </>
              ) : rankLoading ? (
