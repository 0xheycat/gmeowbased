...
const HowItWorks = dynamic(() => import('@/components/home/HowItWorks').then(mod => ({ default: mod.HowItWorks })), {
  loading: () => <div className="animate-pulse bg-slate-100/5 dark:bg-slate-100/90 dark:bg-white/5/5 rounded-lg h-96 mx-auto max-w-6xl my-16" />,
})
...
const ConnectWalletSection = dynamic(() => import('@/components/home/ConnectWalletSection').then(mod => ({ default: mod.ConnectWalletSection })), {
  loading: () => <div className="animate-pulse bg-slate-100/5 dark:bg-slate-100/90 dark:bg-white/5/5 rounded-lg h-64 mx-auto max-w-6xl my-16" />,
})
