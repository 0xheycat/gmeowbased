...
export async function GET(req: NextRequest) {
  return withFrameImageCache({
    ...
    generator: async ({ searchParams }) => {
      ...
      const questId = getStringParam(searchParams, 'questId', '')
      const questName = getStringParam(searchParams, 'questName', 'Verification')
      const status = getStringParam(searchParams, 'status', 'Pending')
      const user = getStringParam(searchParams, 'user', '')
      const fid = getStringParam(searchParams, 'fid', '')
      const chain = getStringParam(searchParams, 'chain', 'Base')
