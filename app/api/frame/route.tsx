...
const DEFAULT_HTML_HEADERS: Record<string, string> = {
  ...
  'content-security-policy': "frame-ancestors 'self' https://gmeowhq.art https://*.gmeowhq.art https://warpcast.com https://*.warpcast.com https://farcaster.xyz https://*.farcaster.xyz https://base.dev https://*.base.dev https://privy.farcaster.xyz https://wallet.farcaster.xyz; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://privy.farcaster.xyz https://wallet.farcaster.xyz https://*.farcaster.xyz https://*.base.dev; connect-src 'self' https://privy.farcaster.xyz https://wallet.farcaster.xyz https://*.farcaster.xyz https://api.neynar.com https://*.base.dev wss://*.farcaster.xyz; img-src 'self' data: https: blob:;",
