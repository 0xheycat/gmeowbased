  ...
  return (
    ...
    >
      <label className="flex flex-col gap-1 text-sm text-white/80">
        Admin passphrase
        <input
          className="rounded-lg border border-white/15 bg-black/40 px-3 py-3 min-h-6 text-sm text-white focus:border-emerald-400 focus:outline-none focus:ring-1 focus:ring-emerald-400"
          type="password"
