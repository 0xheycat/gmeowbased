...
export default async function AdminLoginPage({ searchParams }: { searchParams: Promise<SearchParams> }) {
  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-4 py-12">
      <div className="rounded-2xl border border-slate-200 dark:border-slate-700/10 bg-black dark:bg-slate-950/60 p-6 shadow-2xl shadow-emerald-500/10 backdrop-blur">
        ...
        {securityEnabled ? (
          ...
          <div className="mt-6 rounded-lg border border-amber-400/40 bg-amber-500/10 p-4 text-sm text-amber-200">
      ...
      <div className="mt-6 text-center text-sm text-[var(--px-sub)]">
