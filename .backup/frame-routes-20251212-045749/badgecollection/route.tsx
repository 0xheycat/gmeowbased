...
export async function GET(req: NextRequest) {
  try {
    ...
    const earnedCount = searchParams.get('earnedCount') || '0'
    const eligibleCount = searchParams.get('eligibleCount') || '0'
    const address = searchParams.get('address') || ''
    const fid = searchParams.get('fid') || ''
    const badgeXp = searchParams.get('badgeXp') || '0'
    const earnedBadges = searchParams.get('earnedBadges') || ''
    ...
    console.error('Badge collection frame error:', error)
    return new Response('Error generating badge collection frame', { status: 500 })
  }
}
