...
import { footerCallouts } from './nav-data'

export function SiteFooter() {
  const year = new Date().getFullYear()

  return (
    <footer className="site-font border-t border-white dark:border-slate-700/10 bg-slate-100/5 dark:bg-slate-100/90 dark:bg-white/5 px-4 py-12 backdrop-blur-md sm:px-6 lg:px-10">
