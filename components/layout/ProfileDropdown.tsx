...
export function ProfileDropdown() {
  ...
  if (!mounted) {
    return (
      <div className="flex h-10 w-10 items-center justify-center rounded-full border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
  ...
  if (loading) {
    return (
      <div className="flex h-10 w-10 items-center justify-center rounded-full border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
        <div className="h-4 w-4 animate-spin rounded-full border-2 border-gray-300 dark:border-gray-600 border-t-accent-green" />
      </div>
    )
  }
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="flex items-center gap-2 rounded-full border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-1.5 transition-all hover:border-accent-green/30 hover:bg-accent-green/10 hover:shadow-md sm:p-1 sm:pr-3"
      ...
      >
        ...
        <span className="hidden text-sm font-medium text-gray-900 dark:text-white sm:inline">@{username}</span>
        <KeyboardArrowDownIcon
          sx={{ fontSize: 14 }}
          className={`hidden sm:block text-gray-600 dark:text-gray-400 transition-transform ${isOpen ? 'rotate-180' : ''}`}
        />
      </button>
      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-[calc(100vw-2rem)] max-w-xs sm:w-72 animate-in fade-in slide-in-from-top-2 duration-200">
          <div className="overflow-hidden rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-2xl">
            {/* Profile header */}
            <div className="border-b border-gray-100 dark:border-gray-800 p-4">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400">FID: {profile?.fid ?? '—'}</p>
                </div>
                {profile?.powerBadge && (
            ...
            {/* Mini stats */}
            <div className="grid grid-cols-3 gap-2 border-b border-gray-100 dark:border-gray-800 p-4">
              <div className="text-center">
                ...
                <p className="mt-1 text-[10px] uppercase tracking-wider text-gray-600 dark:text-gray-400">Points</p>
              </div>
              <div className="text-center">
                ...
                <p className="mt-1 text-[10px] uppercase tracking-wider text-gray-600 dark:text-gray-400">Streak</p>
              </div>
              <div className="text-center">
                <div className="text-sm font-bold text-gray-900 dark:text-white">{rank ? `#${rank}` : '—'}</div>
                <p className="mt-1 text-[10px] uppercase tracking-wider text-gray-600 dark:text-gray-400">Rank</p>
              </div>
            </div>
            ...
            <div className="p-2">
              ...
              {cachedWallets.length > 1 && (
                <div className="mb-2 px-3 py-2 rounded-lg bg-gray-50 dark:bg-gray-800">
                  <div className="flex items-center gap-2 mb-2">
                    <WalletIcon sx={{ fontSize: 14 }} className="text-gray-600 dark:text-gray-400" />
              ...
              <Link
                ...
                className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 transition-colors hover:bg-gray-50 dark:hover:bg-gray-800"
              >
            ...
            <div className="border-t border-gray-100 dark:border-gray-800 p-3">
              <div className="flex items-center justify-between text-xs">
                ...
                <code className="rounded bg-gray-100 dark:bg-gray-800 px-2 py-1 text-gray-700 dark:text-gray-300">
