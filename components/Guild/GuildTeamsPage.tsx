                    ...
                    >
                      <div className="flex flex-wrap items-start justify-between gap-3">
                        <div className="space-y-1">
                          ...
                          <div className="text-sm font-semibold text-white dark:text-white">{guild.teamName || `Guild #${guild.teamId}`}</div>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="truncate text-sm font-semibold text-white dark:text-white">{team.name || `Guild #${team.teamId}`}</div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            {HOW_IT_WORKS_STEPS.map((step, idx) => (
              <div key={step.title} className="guild-panel guild-panel--muted guild-card guild-card--hover rounded-2xl p-4">
                ...
                <div className="mt-1 text-lg font-semibold text-white dark:text-white">{step.title}</div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
            {FRIENDLY_TIPS.map((tip) => (
              <div key={tip.title} className="guild-panel guild-panel--muted guild-card guild-card--hover rounded-2xl p-4">
                ...
                <div className="mt-2 text-sm font-semibold text-white dark:text-white">{tip.title}</div>
