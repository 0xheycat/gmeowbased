          ...
          <div className="px-4 py-3 border-t theme-border-subtle space-y-2">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                {/* Sun icon (light mode) */}
                <svg
                  className={`w-5 h-5 theme-text-secondary absolute transition-all duration-200 ${theme === 'light' ? 'scale-100 rotate-0' : 'scale-0 rotate-90'}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                {/* Moon icon (dark mode) */}
                <svg
                  className={`w-5 h-5 theme-text-secondary absolute transition-all duration-200 ${theme === 'dark' ? 'scale-100 rotate-0' : 'scale-0 -rotate-90'}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
