      ...
      {reminders.length ? (
        <ul className="space-y-3">
          {reminders.map((reminder) => {
            const toneClass = reminder.tone ? toneClasses[reminder.tone] : 'border-white/12 bg-white/5 text-white/80'
            return (
              <li
                key={reminder.id}
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-1 text-[12px] leading-relaxed text-white/70">{reminder.description}</p>
        ...
        <div className="rounded-2xl border border-dashed border-white/12 bg-white/5 p-6 text-center text-[12px] text-[var(--px-sub)]">
