        ...
        <div className="space-y-4">
          <div className="grid grid-cols-3 gap-2 text-center">
            <div className="rounded-lg border border-white/10 bg-white/5 px-2 py-3">
              ...
              <div className="text-lg font-semibold text-white">{formatCompactNumber(totals?.points24h ?? 0)}</div>
            </div>
            <div className="rounded-lg border border-white/10 bg-white/5 px-2 py-3">
              <div className="text-[10px] uppercase tracking-[0.24em] text-[var(--px-sub)]">Mentions</div>
              <div className="text-lg font-semibold text-white">{totals?.mentions24h ?? 0}</div>
            ...
            <div className="rounded-lg border border-white/10 bg-white/5 px-2 py-3">
              ...
              <div className="text-lg font-semibold text-white">{totals?.awarded24h ?? 0}</div>
          ...
          {limits ? (
            <div className="rounded-lg border border-white/5 bg-white/5 px-3 py-2 text-[10px] text-[var(--px-sub)]">
              <div>
                Global cap:{' '}
