          ...
          <button
            ...
            className={clsx(
              ...
              active
                ...
                : 'bg-slate-100/90 dark:bg-white/5 text-slate-700 dark:text-white/70 border border-slate-200 dark:border-white/10 hover:border-emerald-300/40 hover:text-slate-950 dark:text-white'
            )}
