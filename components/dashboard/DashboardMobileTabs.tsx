...
export default function DashboardMobileTabs<Id extends string = string>({
  ...
  return (
    <div className="flex items-center justify-between gap-2 overflow-x-auto rounded-2xl border border-white dark:border-slate-700/10 bg-slate-100/5 dark:bg-slate-100/90 dark:bg-white/5/5 p-2">
      {tabs.map((tab) => {
          ...
          <button
            ...
            className={clsx(
              ...
              active
                ...
                : 'bg-slate-100/90 dark:bg-white/5/5 text-slate-700 dark:text-slate-500/70 dark:text-slate-950 dark:text-slate-700 dark:text-white/70 border border-slate-200 dark:border-white/10/10 hover:border-emerald-300/40 hover:text-slate-950 dark:text-white'
            )}
