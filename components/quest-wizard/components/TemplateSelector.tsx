		...
		<div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-8">
			<div className="mx-auto max-w-6xl">
				...
				<div className="mb-8 text-center">
					<h1 className="text-4xl font-bold text-slate-950 dark:text-white">Create Your Quest</h1>
	...
	return (
		...
		>
			...
			<div className="relative">
				...
				{/* Title & Description */}
				<h3 className="mb-2 text-lg font-semibold text-slate-950 dark:text-white">{template.name}</h3>
