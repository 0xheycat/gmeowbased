...
export function AccessibleButton({
	...
	const variants = {
		primary: 'bg-sky-500 hover:bg-sky-600 text-slate-900 dark:text-white',
		secondary: 'bg-slate-100/90 dark:bg-white/5 hover:bg-slate-100/90 dark:bg-white/5 text-slate-900 dark:text-white',
		danger: 'bg-red-500 hover:bg-red-600 text-slate-900 dark:text-white',
	}
...
export function ProgressIndicator({
	...
	return (
		...
		>
			...
			<div className="h-2 overflow-hidden rounded-full bg-slate-100/10 dark:bg-white/5">
				<div
