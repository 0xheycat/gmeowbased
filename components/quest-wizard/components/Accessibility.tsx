...
export function SkipToContent({ targetId = 'main-content' }: { targetId?: string }) {
	return (
		<a
			href={`#${targetId}`}
			className="absolute left-4 top-4 z-50 -translate-y-24 rounded-lg bg-sky-500 px-4 py-2 font-semibold text-slate-950 dark:text-slate-950 dark:text-white transition focus:translate-y-0"
		>
...
export function AccessibleButton({
	...
	const variants = {
		...
		secondary: 'bg-slate-100/90 dark:bg-white/5 hover:bg-slate-100/90 dark:bg-white/5 text-slate-900 dark:text-slate-950 dark:text-white',
...
export function ProgressIndicator({
	...
	return (
		...
		>
			...
			<div className="h-2 overflow-hidden rounded-full bg-slate-100/10 dark:bg-slate-100/90 dark:bg-white/5">
				<div
