			...
			<div className="space-y-4">
				...
				<div className="flex justify-end gap-2">
					<button
						...
						className="rounded-lg bg-slate-100/5 dark:bg-white/5 px-3 py-1.5 text-xs text-slate-400 transition hover:bg-slate-100/10 dark:bg-white/5"
					>
						Standard View
					</button>
					<button
		...
		<div className="space-y-4">
			...
			{stepIndex === 3 && (
				<div className="flex justify-end gap-2">
					<button
						onClick={() => setViewMode('standard')}
						className="rounded-lg bg-slate-100/5 dark:bg-white/5 px-3 py-1.5 text-xs text-slate-400"
					>
						Standard View
					</button>
					<button
...
function CardLoadingSkeleton() {
	return (
		<div className="h-[440px] w-full max-w-[320px] animate-pulse rounded-2xl bg-slate-100/5 dark:bg-white/5" />
	)
}
