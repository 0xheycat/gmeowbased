					...
					<div className={`rounded-2xl border px-4 py-3 text-xs ${verificationClass}`}>
						<div className="flex flex-wrap items-center justify-between gap-3">
							...
							<button
								...
								className="rounded-full border border-slate-200 dark:border-slate-700/10 bg-slate-100/10 dark:bg-white/5 px-3 py-1 text-[11px] text-slate-100 transition hover:border-slate-300 dark:hover:border-slate-700/20 hover:bg-slate-100/20 dark:hover:bg-white/5 disabled:cursor-not-allowed disabled:opacity-50"
							>
								{verifyButtonLabel}
							</button>
						</div>
