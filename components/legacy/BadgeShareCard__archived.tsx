...
export function BadgeShareCard({
  ...
  return (
    <div
      className={clsx(
        'relative overflow-hidden rounded-2xl border border-slate-200 dark:border-white/10 bg-slate-100/90 dark:bg-white/5 p-5 transition-all hover:border-slate-200 dark:border-white/10 hover:bg-slate-100/90 dark:bg-white/5',
        className
      )}
    >
      {/* Tier glow effect */}
      ...
      <div className="relative flex items-start gap-4">
        ...
        >
          ...
          {badge.minted && (
            <div className="absolute bottom-1 right-1 rounded-full bg-emerald-500/90 p-1">
              <svg
                className="h-3 w-3 text-slate-950 dark:text-white"
                fill="currentColor"
                viewBox="0 0 20 20"
              >
                <path
        ...
        <div className="min-w-0 flex-1">
          <h3 className="text-base font-semibold text-slate-950 dark:text-white">{badgeName}</h3>
          ...
          {/* Description */}
          {badgeDescription && (
            <p className="mt-2 text-xs text-slate-950 dark:text-white/60 line-clamp-2">
              {badgeDescription}
            </p>
          )}

          {/* Earned date */}
          <p className="mt-2 text-[10px] text-slate-950 dark:text-white/40">
      ...
      <button
        ...
        className={clsx(
          ...
          'border border-slate-200 dark:border-white/10 bg-slate-100/90 dark:bg-white/5 text-slate-950 dark:text-white hover:border-slate-200 dark:border-white/10 hover:bg-slate-100/90 dark:bg-white/5',
