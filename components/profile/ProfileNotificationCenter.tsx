      ...
      >
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            {unreadCount > 0 && (
              <span className="absolute -right-1 -top-1 flex h-5 w-5 items-center justify-center rounded-full bg-emerald-500 text-[10px] font-bold text-slate-950 dark:text-white shadow-[0_0_12px_rgba(16,185,129,0.6)]">
      ...
      {isExpanded && (
        <div className="mt-3 space-y-4 rounded-xl border border-white dark:border-slate-700/10 bg-slate-100/5 dark:bg-white/5 p-4">
          ...
          <div className="flex flex-wrap items-center justify-between gap-2">
            ...
            <button
              type="button"
              className="rounded-lg border border-white dark:border-slate-700/10 bg-slate-100/5 dark:bg-white/5 px-3 py-1 text-[10px] uppercase tracking-[0.22em] text-slate-950 dark:text-white/80 transition hover:border-rose-300/40 hover:text-slate-950 dark:text-white disabled:opacity-30"
              onClick={() => dismissAll()}
          ...
          <div className="space-y-3">
            {filtered.length ? (
              ...
              <div className="rounded-xl border border-dashed border-white dark:border-slate-700/15 bg-slate-100/3 dark:bg-white/5 p-8 text-center">
          ...
          {/* Show more indicator */}
          {filtered.length > 10 && (
            <div className="rounded-lg border border-white dark:border-slate-700/10 bg-slate-100/3 dark:bg-white/5 px-3 py-2 text-center text-sm text-[var(--px-sub)]">
