...
const CATEGORY_LABELS: Record<NotificationCategory, { label: string; icon: string; description: string }> = {
  system: { label: 'System', icon: 'settings_input_antenna', description: 'Important app updates and alerts' },
  quest: { label: 'Quests', icon: 'explore', description: 'Quest completions and updates' },
  badge: { label: 'Badges', icon: 'military_tech', description: 'Badge achievements and unlocks' },
  guild: { label: 'Guilds', icon: 'castle', description: 'Guild activity and invites' },
  reward: { label: 'Rewards', icon: 'diamond', description: 'Points and reward notifications' },
  tip: { label: 'Tips', icon: 'bolt', description: 'Incoming tips and mentions' },
  level: { label: 'Level Ups', icon: 'rocket_launch', description: 'Level progression milestones' },
  streak: { label: 'Streaks', icon: 'local_fire_department', description: 'Streak achievements and warnings' },
  gm: { label: 'GM Posts', icon: 'waving_hand', description: 'Daily GM post notifications' },
  achievement: { label: 'Achievements', icon: 'emoji_events', description: 'Achievement unlock notifications' },
  social: { label: 'Social', icon: 'people', description: 'Social interactions and follows' },
}
    ...
    <div className={className}>
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-slate-950 dark:text-white">Notification Settings</h3>
