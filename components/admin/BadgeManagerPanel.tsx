    ...
    <section className="px-2 sm:px-4">
      <div className="mx-auto w-full max-w-6xl rounded-3xl border border-white dark:border-slate-700/10 bg-slate-100/5 dark:bg-white/5 p-5 shadow-lg shadow-emerald-500/10">
        ...
        {activeTab === 'templates' && (
          <div>
            <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
              <h3 className="text-sm font-semibold text-slate-950 dark:text-white">Badge Templates</h3>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2">
                    <h3 className="truncate text-sm font-semibold text-slate-950 dark:text-white">{template.name}</h3>
                    <span
                      className={clsx(
                  ...
                  {template.description ? (
                    <p className="mt-2 line-clamp-3 text-[12px] text-slate-950 dark:text-white/70">{template.description}</p>
                  ) : null}
                </div>
              </div>
              <dl className="mt-3 grid grid-cols-2 gap-2 text-[11px] text-slate-950 dark:text-white/70">
                <div>
                ...
                <div className="col-span-2">
                  ...
                  <dd className="truncate text-slate-950 dark:text-white/80">{template.slug}</dd>
                </div>
              </dl>
        ...
        {activeTab === 'queue' && (
          <div>
            <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
              <h3 className="text-sm font-semibold text-slate-950 dark:text-white">Mint Queue</h3>
              <button
                type="button"
                className="pixel-button btn-sm"
                ...
                {mintQueue.map((mint) => (
                  <div key={mint.id} className="rounded-2xl border border-white dark:border-slate-700/10 bg-slate-100/5 dark:bg-white/5 p-4">
                    <div className="flex flex-wrap items-center justify-between gap-3">
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2">
                          <span className="text-sm font-semibold text-slate-950 dark:text-white">FID {mint.fid}</span>
        ...
        {activeTab === 'registry' && (
          <div>
            <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
              <h3 className="text-sm font-semibold text-slate-950 dark:text-white">Badge Registry</h3>
              <button
                type="button"
                className="pixel-button btn-sm"
                ...
                <div className="rounded-2xl border border-white dark:border-slate-700/10 bg-slate-100/5 dark:bg-white/5 p-4">
                  <div className="grid gap-2 text-[12px]">
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold text-slate-950 dark:text-white">{badgeRegistry.version}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-[var(--px-sub)]">Last Updated:</span>
                      <span className="font-semibold text-slate-950 dark:text-white">{badgeRegistry.lastUpdated}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-[var(--px-sub)]">Total Badges:</span>
                      <span className="font-semibold text-slate-950 dark:text-white">{badgeRegistry.badges.length}</span>
                    </div>
                  </div>
                </div>
                    ...
                    {Object.entries(badgeRegistry.tiers).map(([key, tier]) => (
                      <div key={key} className="rounded-2xl border border-white dark:border-slate-700/10 bg-slate-100/5 dark:bg-white/5 p-3">
                        <div className="flex items-center gap-2">
                          ...
                          />
                          <span className="text-sm font-semibold text-slate-950 dark:text-white">{tier.name}</span>
                        </div>
                    ...
                    {badgeRegistry.badges.map((badge) => (
                      <div key={badge.id} className="rounded-2xl border border-white dark:border-slate-700/10 bg-slate-100/5 dark:bg-white/5 p-4">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="min-w-0 flex-1">
                            <div className="flex items-center gap-2">
                              <span className="text-sm font-semibold text-slate-950 dark:text-white">{badge.name}</span>
                              <span
                            ...
                            <div className="mt-2 flex flex-wrap gap-2 text-[11px]">
                              <span className="text-[var(--px-sub)]">Type: <span className="font-mono text-slate-950 dark:text-white">{badge.badgeType}</span></span>
        ...
        {activeTab === 'assign' && (
          <div>
            <div className="mb-4">
              <h3 className="text-sm font-semibold text-slate-950 dark:text-white">Manual Badge Assignment</h3>
            ...
            <div className="rounded-2xl border border-white dark:border-slate-700/10 bg-slate-100/5 dark:bg-white/5 p-5">
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <label className="flex flex-col gap-1 text-[12px]">
                  <span className="text-slate-950 dark:text-white">Badge Type</span>
                  <input
                    type="text"
                    className="pixel-input"
            ...
            {badgeRegistry && (
              <div className="mt-5">
                <h4 className="mb-3 text-sm font-semibold text-slate-950 dark:text-white">Available Badge Types</h4>
