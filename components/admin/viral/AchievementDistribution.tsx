    ...
    <div className="rounded-3xl border border-white dark:border-slate-700/10 bg-slate-100/5 dark:bg-white/5 p-5 shadow-lg backdrop-blur">
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <div className="flex rounded-lg border border-white dark:border-slate-700/20 bg-slate-100/10 dark:bg-white/5 p-1">
            <button
              onClick={() => setViewMode('distribution')}
              className={`rounded px-3 py-1 text-[10px] font-medium transition ${
                viewMode === 'distribution'
                  ? 'bg-emerald-500/30 text-emerald-200'
                  : 'text-slate-950 dark:text-white/60 hover:text-slate-950 dark:text-white'
              }`}
              type="button"
            >
              Distribution
              ...
              <div className="grid grid-cols-2 gap-3">
                {data.achievements.map((achievement) => (
                  <div
                    ...
                    className="rounded-xl border border-white dark:border-slate-700/10 bg-slate-100/5 dark:bg-white/5 p-3 transition hover:border-emerald-400/30"
                  >
                    <div className="flex items-center gap-2">
