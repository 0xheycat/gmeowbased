  ...
  return (
    ...
    >
      <label className="flex flex-col gap-1 text-[12px] text-slate-950 dark:text-white/80">
        Admin passphrase
        <input
          className="rounded-lg border border-slate-200 dark:border-slate-700/15 bg-black dark:bg-slate-950/40 px-3 py-2 text-sm text-slate-950 dark:text-white focus:border-emerald-400 focus:outline-none focus:ring-1 focus:ring-emerald-400"
          type="password"
      ...
      <label className="flex items-center gap-2 text-[12px] text-slate-950 dark:text-white/70">
        <input
          type="checkbox"
          className="h-4 w-4 rounded border-slate-200 dark:border-slate-700/30 bg-black dark:bg-slate-950/40 text-emerald-400 focus:ring-emerald-400"
          checked={remember}
