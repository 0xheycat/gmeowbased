...
function CategoryBar({
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-4" style={{ gridTemplateColumns: `repeat(${values.length}, minmax(0, 1fr))` }}>
        {values.map((value, i) => (
          <div key={i} className="flex flex-col items-center">
            <div className="w-full bg-gray-100 dark:bg-dark-bg-elevated rounded-lg h-10 relative overflow-hidden mb-2 shadow-sm">
              <motion.div
            ...
            <div className={`text-sm font-bold ${i === winnerIndex ? 'text-brand' : 'text-gray-700 dark:text-gray-300'}`}>
            ...
            {i === winnerIndex && value > 0 && (
              ...
              >
                <EmojiEventsIcon className="w-4 h-4 text-yellow-500 mt-1" />
              </motion.div>
            )}
          </div>
        ))}
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-gradient-to-r from-brand to-purple-600 rounded-lg flex items-center justify-center shadow-lg">
            ...
            <div id="comparison-content" className="p-6 bg-gray-50 dark:bg-gray-900">
              ...
              >
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 dark:text-white px-4">
            ...
            >
              ...
              {showSuccessToast && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: 20 }}
                  className="fixed bottom-4 left-1/2 -translate-x-1/2 bg-green-500 text-white px-6 py-3 rounded-lg shadow-xl z-[70] flex items-center gap-2"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
