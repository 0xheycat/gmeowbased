  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className="relative rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-2xl backdrop-blur-sm">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="relative flex-shrink-0">
                  ...
                  {member.farcaster?.powerBadge && (
                    <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-purple-500 rounded-full flex items-center justify-center border-2 border-white dark:border-gray-900">
            ...
            {/* Arrow pointer */}
            <div className="absolute -top-1.5 left-6 h-3 w-3 rotate-45 border-l border-t border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900" />
          </div>
        </motion.div>
      )}
